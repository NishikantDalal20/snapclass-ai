...
from src.pipelines.face_pypline import predict_attendance
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='alicejohnson')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder="Alice Johnson")
